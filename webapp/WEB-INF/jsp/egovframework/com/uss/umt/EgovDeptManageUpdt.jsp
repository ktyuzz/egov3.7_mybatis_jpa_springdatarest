...
<div class="wTableFrm">
	...
	<div class="btn">
		...
		<button class="btn_s2" onClick="fncDeptManageDelete();return false;" title="<spring:message code="button.delete" /> <spring:message code="input.button" />"><spring:message code="button.delete" /></button>
