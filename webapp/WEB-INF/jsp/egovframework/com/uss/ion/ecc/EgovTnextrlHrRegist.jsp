	...
	<tbody>
		...
		<tr>
			...
			<td class="left">
			    ...
			    <a href="#" onClick="fn_egov_popup_event()"><img src="<c:url value='/images/egovframework/com/cmm/btn/btn_search.gif'/>" align="middle" style="border:0px" alt=<spring:message code="comCopSmtDsm.registBtn.schdulCn"/> title="<spring:message code="comCopSmtDsm.registBtn.schdulCn"/>"></a>
